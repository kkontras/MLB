...
class Monitor_n_Save:
    ...
    def save(self, verbose=False, is_best_model=False, model_save=True, post_test_results=False):
        ...
        train_metrics.update(
            {
                ...
                "learning_rate": self.agent.scheduler.lr_history[
                    max(self.agent.logs["current_step"] - self.agent.config.early_stopping.validate_every, 0) : self.agent.logs["current_step"]
                ],
            }
        )
