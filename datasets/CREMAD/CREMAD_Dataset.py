...
class CremadDataset(Dataset):
    ...
    def split_inclusive(self, mode, class_dict):
        ...
        if self.split_mode == "stratified_split":
            ...
            X_train, X_val, y_train, y_val = train_test_split(
                X_trainval, y_trainval, test_size=self.config.dataset.get("val_split_rate", 0.1), random_state=self.config.training_params.seed, stratify=y_trainval
            )
    ...
    def _get_images(self, idx):
        ...
        if self.mode == "train":
            ...
            transform = transforms.Compose(
                [transforms.ToTensor(), transforms.Resize(size=(224, 224), antialias=True), transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])]
            )
...
# a = CremadDataset(config = {}, visual_path = "project_default_dir/CremaD/CREMA-D",
#                   audio_path="project_default_dir/CremaD/CREMA-D/AudioWAV", fps=1, mode="train")
# b = a.__getitem__(0)
# import matplotlib.pyplot as plt
# import einops
...
# save_dir = "project_default_dir/data/2023_data/CREMAD_models/unimodal_audio_VAVL_linearcls_fold0.pth.tar"
...
# new_save_dir = 'project_default_dir/data/2023_data/CREMAD_models/unimodal_audio_VAVL_linearcls_nm_fold0.pth.tar'
