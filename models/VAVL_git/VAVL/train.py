...
def main(args):
    ...
    train_set = utils.AudVidSet(
        train_wavs, train_vids, train_labs, train_utts, print_dur=True, lab_type=lab_type, print_utt=True, label_config=DataManager.get_label_config(lab_type)
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--label_type", choices=["dimensional", "categorical"], default="categorical", type=str)
    ...
    parser.add_argument("--out_dropout", type=float, default=0.2, help="output layer dropout (default: 0.2")
